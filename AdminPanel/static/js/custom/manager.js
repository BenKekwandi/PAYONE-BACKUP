            ...
            success: function (array) {
                ...
                for (var i = 0; i < array.length; i++) {
                    dataSet.push([
                        ...
                        array[i].phone,
                        array[i].address,
                        '<a data-bs-toggle="modal" data-bs-target="#editModal" data-manager="' + array[i].id + '" href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md edit-btn" title="Düzenle">\
