$(document).ready(function () {
        ...
        if (formData) {
            $.ajax({
                ...
                error: function (error) {
                    console.log("Damn!!!!!");
                    alert("Invalid file type. Allowed extensions are: .pdf, .doc, .docx, .jpg, .jpeg")
                    console.log(error);
                }
            });
        }
    ...
    function downloadFile(filename) {
        var downloadUrl = "/download-file/" + filename + '/' + companyId;
    ...
    function deleteFile(filename) {
        $.ajax({
            url: "/delete-file/" + filename + '/' + companyId,
            method: "DELETE",
            headers: {
                'X-CSRFToken': csrfToken
            },
